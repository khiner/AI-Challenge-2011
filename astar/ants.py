...
class Ants():
    def __init__(self):
        ...
        self.rows = None
        self.map = None
        self.nodes = {} # find the node corresponding to a pos
        self.graph = {} # maps a node to a (neighbors) set
        self.unfinished_nodes = [] # hold all self.nodes with unknown neighbors
        self.orders = {} # track all moves, prevent collisions
        self.destinations = set() # temporarily using a simple set for all destinations        
        self.hill_list = {}
        self.ant_list = {}
    ...
    def neighbors(self, loc):
        'returns a set of all neighbors for a given location.\
        note that these could be insibile'
        neighbors = set()
